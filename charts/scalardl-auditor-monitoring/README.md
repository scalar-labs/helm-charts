...
|-----|------|---------|-------------|
| alloy.alloy.configMap.content | string | `"{{ include \"scalardl-auditor-monitoring.alloyContent\" . }}\n"` |  |
...
| alloy.controller.podLabels."app.kubernetes.io/app" | string | `"scalardl-auditor-monitoring"` |  |
...
| loki.loki.podLabels."app.kubernetes.io/app" | string | `"scalardl-auditor-monitoring"` |  |
...
| prometheus.extraScrapeConfigs | string | `"{{ include \"scalardl-auditor-monitoring.prometheusExtraScrapeConfig\" . }}\n"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].authorization.credentials_file | string | `"/var/run/secrets/kubernetes.io/serviceaccount/token"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].authorization.type | string | `"Bearer"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[1].action | string | `"replace"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].relabel_configs[2].action | string | `"replace"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[1].tls_config.insecure_skip_verify | bool | `false` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].honor_labels | bool | `true` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].honor_timestamps | bool | `true` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].job_name | string | `"kube-state-metrics"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].kubernetes_sd_configs[0].role | string | `"endpoints"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].metrics_path | string | `"/metrics"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[0].action | string | `"replace"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[0].source_labels[0] | string | `"job"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[0].target_label | string | `"__tmp_prometheus_job_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[10].action | string | `"drop"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[10].regex | string | `"(Failed|Succeeded)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[10].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[10].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[10].source_labels[0] | string | `"__meta_kubernetes_pod_phase"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[11].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[11].replacement | string | `"${1}"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[11].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[11].source_labels[0] | string | `"__meta_kubernetes_service_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[11].target_label | string | `"job"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[12].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[12].regex | string | `"(.+)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[12].replacement | string | `"${1}"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[12].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[12].source_labels[0] | string | `"__meta_kubernetes_service_label_app_kubernetes_io_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[12].target_label | string | `"job"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[13].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[13].replacement | string | `"http"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[13].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[13].target_label | string | `"endpoint"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[14].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[14].regex | string | `"(.+);"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[14].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[14].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[14].source_labels[0] | string | `"__address__"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[14].source_labels[1] | string | `"__tmp_hash"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[14].target_label | string | `"__tmp_hash"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[15].action | string | `"hashmod"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[15].modulus | int | `1` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[15].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[15].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[15].source_labels[0] | string | `"__tmp_hash"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[15].target_label | string | `"__tmp_hash"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[16].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[16].regex | string | `"0"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[16].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[16].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[16].source_labels[0] | string | `"__tmp_hash"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[1].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[1].regex | string | `"(scalardl-auditor-monitoring);true"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[1].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[1].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[1].source_labels[0] | string | `"__meta_kubernetes_service_label_app_kubernetes_io_app"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[1].source_labels[1] | string | `"__meta_kubernetes_service_labelpresent_app_kubernetes_io_app"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[2].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[2].regex | string | `"(kube-state-metrics);true"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[2].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[2].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[2].source_labels[0] | string | `"__meta_kubernetes_service_label_app_kubernetes_io_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[2].source_labels[1] | string | `"__meta_kubernetes_service_labelpresent_app_kubernetes_io_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[3].action | string | `"keep"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[3].regex | string | `"http"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[3].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[3].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[3].source_labels[0] | string | `"__meta_kubernetes_endpoint_port_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[4].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[4].regex | string | `"Node;(.*)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[4].replacement | string | `"${1}"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[4].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[4].source_labels[0] | string | `"__meta_kubernetes_endpoint_address_target_kind"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[4].source_labels[1] | string | `"__meta_kubernetes_endpoint_address_target_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[4].target_label | string | `"node"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[5].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[5].regex | string | `"Pod;(.*)"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[5].replacement | string | `"${1}"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[5].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[5].source_labels[0] | string | `"__meta_kubernetes_endpoint_address_target_kind"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[5].source_labels[1] | string | `"__meta_kubernetes_endpoint_address_target_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[5].target_label | string | `"pod"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[6].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[6].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[6].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[6].source_labels[0] | string | `"__meta_kubernetes_namespace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[6].target_label | string | `"namespace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[7].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[7].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[7].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[7].source_labels[0] | string | `"__meta_kubernetes_service_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[7].target_label | string | `"service"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[8].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[8].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[8].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[8].source_labels[0] | string | `"__meta_kubernetes_pod_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[8].target_label | string | `"pod"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[9].action | string | `"replace"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[9].replacement | string | `"$1"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[9].separator | string | `";"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[9].source_labels[0] | string | `"__meta_kubernetes_pod_container_name"` |  |
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[9].target_label | string | `"container"` |  |
