# scalar-monitoring-scalardb-cluster
...
| alloy.controller.podLabels."app.kubernetes.io/app" | string | `"scalar-monitoring-scalardb-cluster"` |  |
...
| grafana.extraLabels."app.kubernetes.io/app" | string | `"scalar-monitoring-scalardb-cluster"` |  |
...
| loki.loki.podLabels."app.kubernetes.io/app" | string | `"scalar-monitoring-scalardb-cluster"` |  |
...
| loki.minio.additionalLabels."app.kubernetes.io/app" | string | `"scalar-monitoring-scalardb-cluster"` |  |
| loki.minio.enabled | bool | `true` |  |
| loki.minio.podLabels."app.kubernetes.io/app" | string | `"scalar-monitoring-scalardb-cluster"` |  |
...
| prometheus.commonMetaLabels."app.kubernetes.io/app" | string | `"scalar-monitoring-scalardb-cluster"` |  |
| prometheus.enabled | bool | `true` |  |
| prometheus.kube-state-metrics.customLabels."app.kubernetes.io/app" | string | `"scalar-monitoring-scalardb-cluster"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[3].relabel_configs[1].regex | string | `"(scalar-monitoring-scalardb-cluster);true"` |  |
