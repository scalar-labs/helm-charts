...
Current chart version is `2.9.6`
...
| auditor.image.version | string | `"3.10.5"` | Docker tag |
...
| global.azure | object | `{"images":{"envoy":{"image":"scalar-envoy","registry":"scalar.azurecr.io","tag":"1.6.1"},"scalardlAuditor":{"image":"scalardl-auditor-azure-payg","registry":"scalar.azurecr.io","tag":"3.10.5"}}}` | Azure Marketplace specific configurations. |
...
| global.azure.images.scalardlAuditor | object | `{"image":"scalardl-auditor-azure-payg","registry":"scalar.azurecr.io","tag":"3.10.5"}` | Container image of ScalarDL Auditor for Azure Marketplace. |
