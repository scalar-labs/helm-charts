...
| ingress.hosts | list | `[{"host":"","paths":[{"path":"/graphql","pathType":"ImplementationSpecific"}]}]` | List of rules that are handled with the the ingress. |
| ingress.tls | list | `[]` |  |
| nameOverride | string | `""` |  |
...
| scalarDbGraphQlConfiguration.transaction_manager | string | `"consensus-commit"` | The type of the transaction manager. |
