...
|-----|------|---------|-------------|
| alloy.alloy.configMap.content | string | `"{{ include \"scalardl-ledger-monitoring.alloyContent\" . }}\n"` |  |
...
| prometheus.extraScrapeConfigs | string | `"{{ include \"scalardl-ledger-monitoring.prometheusExtraScrapeConfig\" . }}\n"` |  |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[2].relabel_configs[1].regex | string | `"(scalardl-ledger-monitoring);true"` |  |
