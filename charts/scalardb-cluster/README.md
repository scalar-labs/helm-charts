...
ScalarDB Cluster
Current chart version is `1.10.7`
...
| global.azure | object | `{"images":{"envoy":{"image":"scalar-envoy","registry":"scalar.azurecr.io","tag":"1.6.1"},"scalardbCluster":{"image":"scalardb-cluster-node-azure-payg-premium","registry":"scalar.azurecr.io","tag":"3.17.5"}}}` | Azure Marketplace specific configurations. |
...
| global.azure.images.scalardbCluster | object | `{"image":"scalardb-cluster-node-azure-payg-premium","registry":"scalar.azurecr.io","tag":"3.17.5"}` | Container image of ScalarDB Cluster for Azure Marketplace. |
