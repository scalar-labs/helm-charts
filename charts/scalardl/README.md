...
Current chart version is `4.12.1`
...
| global.azure | object | `{"images":{"envoy":{"image":"scalar-envoy","registry":"scalar.azurecr.io","tag":"1.6.1"},"scalardlLedger":{"image":"scalardl-ledger-azure-payg","registry":"scalar.azurecr.io","tag":"3.13.1"}}}` | Azure Marketplace specific configurations. |
...
| global.azure.images.scalardlLedger | object | `{"image":"scalardl-ledger-azure-payg","registry":"scalar.azurecr.io","tag":"3.13.1"}` | Container image of ScalarDL Ledger for Azure Marketplace. |
...
| ledger.image.version | string | `"3.13.1"` | Docker tag |
