...
Current chart version is `4.9.4`
...
| global.azure | object | `{"images":{"envoy":{"image":"scalar-envoy","registry":"scalar.azurecr.io","tag":"1.6.1"},"scalardlLedger":{"image":"scalardl-ledger-azure-payg","registry":"scalar.azurecr.io","tag":"3.10.3"}}}` | Azure Marketplace specific configurations. |
...
| global.azure.images.scalardlLedger | object | `{"image":"scalardl-ledger-azure-payg","registry":"scalar.azurecr.io","tag":"3.10.3"}` | Container image of ScalarDL Ledger for Azure Marketplace. |
...
| ledger.image.version | string | `"3.10.3"` | Docker tag |
