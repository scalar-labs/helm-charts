...
Current chart version is `4.11.2`
...
| global.azure | object | `{"images":{"envoy":{"image":"scalar-envoy","registry":"scalar.azurecr.io","tag":"1.6.1"},"scalardlLedger":{"image":"scalardl-ledger-azure-payg","registry":"scalar.azurecr.io","tag":"3.12.2"}}}` | Azure Marketplace specific configurations. |
...
| global.azure.images.scalardlLedger | object | `{"image":"scalardl-ledger-azure-payg","registry":"scalar.azurecr.io","tag":"3.12.2"}` | Container image of ScalarDL Ledger for Azure Marketplace. |
...
| ledger.image.version | string | `"3.12.2"` | Docker tag |
